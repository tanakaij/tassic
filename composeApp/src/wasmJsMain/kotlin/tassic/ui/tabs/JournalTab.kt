...
fun JournalTab() {
    ...
    var confirmDeleteEntry by rememberState<JournalEntry?>(null)
    ...
    TabScaffold(
        ...
        confirmDeleteEntry?.let { entry ->
            ConfirmDelete(
                ...
                message = if (entry.audioId != null || entry.imageId != null) {
                    "Its voice note or photo is deleted too. This can't be undone."
                } else {
                    "This can't be undone."
                },
                onConfirm = { store.deleteJournal(entry) },
